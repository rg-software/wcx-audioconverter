...
typedef int (__stdcall *tPkCryptProcW)(int CryptoNr,int Mode,
	...
	extern "C" {
#endif
wcx_export BOOL __stdcall CanYouHandleThisFile(char*);
wcx_export BOOL __stdcall CanYouHandleThisFileW(WCHAR*);
wcx_export int __stdcall CloseArchive(HANDLE);
wcx_export void __stdcall ConfigurePacker(HWND, HINSTANCE);
wcx_export int __stdcall DeleteFiles(char*, char*);
wcx_export int __stdcall DeleteFilesW(WCHAR*, WCHAR*);
wcx_export int __stdcall DoneMemPack(int);
wcx_export int __stdcall GetBackgroundFlags();
wcx_export int __stdcall GetPackerCaps();
wcx_export HANDLE __stdcall OpenArchive(tOpenArchiveData*);
wcx_export HANDLE __stdcall OpenArchiveW(tOpenArchiveDataW*);
wcx_export int __stdcall PackFiles(char*, char*, char*, char*, int);
wcx_export int __stdcall PackToMem(int, char*, int, int*, char*, int, int*, int);
wcx_export int __stdcall PackFiles(char*, char*, char*, char*, int);
wcx_export int __stdcall PackFilesW(WCHAR*, WCHAR*, WCHAR*, WCHAR*, int);
wcx_export void __stdcall PackSetDefaultParams(PackDefaultParamStruct*);
wcx_export void __stdcall PkSetCryptCallback(tPkCryptProc, int, int);
wcx_export void __stdcall PkSetCryptCallbackW(tPkCryptProcW, int, int);
wcx_export int __stdcall ProcessFile(HANDLE, int, char*, char*);
wcx_export int __stdcall ProcessFileW(HANDLE, int, WCHAR*, WCHAR*);
wcx_export int __stdcall ReadHeader(HANDLE, tHeaderData*);
wcx_export int __stdcall ReadHeaderEx(HANDLE, tHeaderDataEx*);
wcx_export int __stdcall ReadHeaderExW(HANDLE, tHeaderDataExW*);
wcx_export void __stdcall SetChangeVolProc(HANDLE, tChangeVolProc);
wcx_export void __stdcall SetChangeVolProcW(HANDLE, tChangeVolProcW);
wcx_export void __stdcall SetProcessDataProc(HANDLE, tProcessDataProc);
wcx_export void __stdcall SetProcessDataProcW(HANDLE, tProcessDataProcW);
wcx_export int __stdcall StartMemPack(int, char*);
wcx_export int __stdcall StartMemPackW(int, WCHAR*);
#ifdef __cplusplus
	}
#endif
